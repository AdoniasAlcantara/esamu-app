...
public class TokenFragment extends Fragment
{
    ...
    public void onAttach(Context context)
    {
        ...
        progress = Dialog.makeProgress(activity, R.string.dialog_wait, R.string.dialog_sending);
    }
        ...
        FirebaseAuth.getInstance()
            ...
            .addOnCompleteListener(activity, task -> {
                if (task.isSuccessful()) {
                    ...
                    // now it's time to register the user in the webservice.
                    doSignUpTask();
                } else {
    ...
    private void doSignUpTask()
    {
        new AsyncTask<Void, Void, ResponseDto>()
        {
            ...
            protected ResponseDto doInBackground(Void... voids)
            {
                ...
                try {
                    response = new EmergencyService().signUp(userDto);
                } catch (Exception e) {
                    Log.e(TAG, "Cannot sign up " + userDto, e);
                }
